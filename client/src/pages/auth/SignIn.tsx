      ...
      <div className="hidden lg:flex flex-1 relative flex-col justify-between p-12 bg-cover bg-center" style={{ backgroundImage: `url(${stockImage})` }}>
        ...
        <div className="relative z-10 max-w-lg">
          <h2 className="font-heading text-4xl font-bold leading-tight mb-6">
            Build voice AI agents <br/> that sound human.
          </h2>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 text-white/80">
              <CheckCircle2 className="w-5 h-5 text-primary" />
              <span>Multilingual support out of the box</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <CheckCircle2 className="w-5 h-5 text-primary" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link href="/signup">
              <a className="text-white hover:underline underline-offset-4 font-semibold">Sign up</a>
            </Link>
          </p>
        </div>
      </div>
